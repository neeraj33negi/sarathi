...
puts status
puts date_of_issue
puts date_of_last_transaction
puts last_transacted_at
puts nt_dl_vailidity_starts_at
puts nt_dl_vailidity_ends_at
puts t_dl_vailidity_starts_at
puts t_dl_vailidity_ends_at
puts hazardous_valid_till
puts hill_valid_till
puts cov_details
puts badge_details
